...
static void SetVideoMode(void)
{
    ...
    // On emscripten it probes a 1x1 canvas against CSS size and can
    // leave the backing store at 0x0 when the wait-GUI window is torn down.
    ...
    printf("asym: renderer ok software=%d\n", force_software_renderer);
