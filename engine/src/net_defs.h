...
typedef struct
{
    ...
    // asymDOOM rule settings (supplied by the controlling client,
    // broadcast to every peer including late joiners):

    int asym_marine_death;
    int asym_demon_death;
    int asym_possess_mask;
    int asym_demon_view;
    int asym_join_tic; // 0 for the original marine; late joiners possess at this tic
