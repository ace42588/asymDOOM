...
// Overridable at compile time (asym_view WASM builds render at true
// 1x/2x/4x of vanilla; the server embed keeps 320x200).
...
/** Integer pixel-doubling of 320×200 into DG_ScreenBuffer (I_FinishUpdate). */
