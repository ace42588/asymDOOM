...
{
    ST_loadData();
    // V_DrawPatch/V_CopyRect address buffers with SCREENWIDTH stride, so the
    // backing screen must be a full-width strip even though the bar is 320
    // wide (hi-res builds: SCREENWIDTH > ST_WIDTH).
