...
/* asymDOOM: capture SFX for thin clients before marine-listener cull */
...
void S_StartSound(void *origin_p, int sfx_id)
{
    ...
    /* Emit wire sound events for cues clients cannot infer from snapshots. */
    asym_notify_sound(origin_p, sfx_id);
