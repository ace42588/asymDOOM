...
// ? (never smaller than the vanilla limits; grows with hi-res builds)
#define MAXWIDTH			(SCREENWIDTH < 1120 ? 1120 : SCREENWIDTH)
#define MAXHEIGHT			(SCREENHEIGHT < 832 ? 832 : SCREENHEIGHT)
